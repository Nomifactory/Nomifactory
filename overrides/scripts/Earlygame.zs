...
val compressorRecipes as IOreDictEntry[IIngredient] = {
	<minecraft:diamond>             : <ore:plateDiamond>              ,
	<minecraft:emerald>             : <ore:plateEmerald>              ,
	<ore:gemAlmandine>              : <ore:plateAlmandine>            ,
	<ore:gemBlueTopaz>              : <ore:plateBlueTopaz>            ,
	<ore:gemGreenSapphire>          : <ore:plateGreenSapphire>        ,
	<ore:gemRutile>                 : <ore:plateRutile>               ,
	<ore:ingotAluminium>            : <ore:plateAluminium>            ,
	<ore:ingotAmericium>            : <ore:plateAmericium>            ,
	<ore:ingotAnnealedCopper>       : <ore:plateAnnealedCopper>       ,
	<ore:ingotAntimony>             : <ore:plateAntimony>             ,
	<ore:ingotArdite>               : <ore:plateArdite>               ,
	<ore:ingotBatteryAlloy>         : <ore:plateBatteryAlloy>         ,
	<ore:ingotBeryllium>            : <ore:plateBeryllium>            ,
	<ore:ingotBlackSteel>           : <ore:plateBlackSteel>           ,
	<ore:ingotBrass>                : <ore:plateBrass>                ,
	<ore:ingotBronze>               : <ore:plateBronze>               ,
	<ore:ingotChrome>               : <ore:plateChrome>               ,
	<ore:ingotCobalt>               : <ore:plateCobalt>               ,
	<ore:ingotCobaltBrass>          : <ore:plateCobaltBrass>          ,
	<ore:ingotConductiveIron>       : <ore:plateConductiveIron>       ,
	<ore:ingotCopper>               : <ore:plateCopper>               ,
	<ore:ingotCupronickel>          : <ore:plateCupronickel>          ,
	<ore:ingotDarkSteel>            : <ore:plateDarkSteel>            ,
	<ore:ingotElectricalSteel>      : <ore:plateElectricalSteel>      ,
	<ore:ingotElectrum>             : <ore:plateElectrum>             ,
	<ore:ingotElectrumFlux>         : <ore:plateElectrumFlux>         ,
	<ore:ingotEnderium>             : <ore:plateEnderium>             ,
	<ore:ingotEndSteel>             : <ore:plateEndSteel>             ,
	<ore:ingotEnergeticAlloy>       : <ore:plateEnergeticAlloy>       ,
	<ore:ingotEpoxid>               : <ore:plateEpoxid>               ,
	<ore:ingotErbium>               : <ore:plateErbium>               ,
	<ore:ingotEuropium>             : <ore:plateEuropium>             ,
	<ore:ingotGallium>              : <ore:plateGallium>              ,
	<ore:ingotGold>                 : <ore:plateGold>                 ,
	<ore:ingotGraphite>             : <ore:plateGraphite>             ,
	<ore:ingotInvar>                : <ore:plateInvar>                ,
	<ore:ingotIridium>              : <ore:plateIridium>              ,
	<ore:ingotIron>                 : <ore:plateIron>                 ,
	<ore:ingotKanthal>              : <ore:plateKanthal>              ,
	<ore:ingotLead>                 : <ore:plateLead>                 ,
	<ore:ingotLithium>              : <ore:plateLithium>              ,
	<ore:ingotLumium>               : <ore:plateLumium>               ,
	<ore:ingotMagnalium>            : <ore:plateMagnalium>            ,
	<ore:ingotManganese>            : <ore:plateManganese>            ,
	<ore:ingotManyullyn>            : <ore:plateManyullyn>            ,
	<ore:ingotNeodymium>            : <ore:plateNeodymium>            ,
	<ore:ingotNichrome>             : <ore:plateNichrome>             ,
	<ore:ingotNickel>               : <ore:plateNickel>               ,
	<ore:ingotNiobium>              : <ore:plateNiobium>              ,
	<ore:ingotNiobiumNitride>       : <ore:plateNiobiumNitride>       ,
	<ore:ingotOsmiridium>           : <ore:plateOsmiridium>           ,
	<ore:ingotOsmium>               : <ore:plateOsmium>               ,
	<ore:ingotPalladium>            : <ore:platePalladium>            ,
	<ore:ingotPlatinum>             : <ore:platePlatinum>             ,
	<ore:ingotPlutonium241>         : <ore:platePlutonium241>         ,
	<ore:ingotPotassium>            : <ore:platePotassium>            ,
	<ore:ingotPotassium>            : <ore:platePotassium>            ,
	<ore:ingotPraseodymium>         : <ore:platePraseodymium>         ,
	<ore:ingotPromethium>           : <ore:platePromethium>           ,
	<ore:ingotPulsatingIron>        : <ore:platePulsatingIron>        ,
	<ore:ingotRedAlloy>             : <ore:plateRedAlloy>             ,
	<ore:ingotReinforcedEpoxyResin> : <ore:plateReinforcedEpoxyResin> ,
	<ore:ingotRubidium>             : <ore:plateRubidium>             ,
	<ore:ingotSamarium>             : <ore:plateSamarium>             ,
	<ore:ingotScandium>             : <ore:plateScandium>             ,
	<ore:ingotSignalum>             : <ore:plateSignalum>             ,
	<ore:ingotSilicon>              : <ore:plateSilicon>              ,
	<ore:ingotSilver>               : <ore:plateSilver>               ,
	<ore:ingotSodium>               : <ore:plateSodium>               ,
	<ore:ingotSolderingAlloy>       : <ore:plateSolderingAlloy>       ,
	<ore:ingotStainlessSteel>       : <ore:plateStainlessSteel>       ,
	<ore:ingotSteel>                : <ore:plateSteel>                ,
	<ore:ingotStrontium>            : <ore:plateStrontium>            ,
	<ore:ingotTantalum>             : <ore:plateTantalum>             ,
	<ore:ingotTellurium>            : <ore:plateTellurium>            ,
	<ore:ingotTerbium>              : <ore:plateTerbium>              ,
	<ore:ingotThorium>              : <ore:plateThorium>              ,
	<ore:ingotThulium>              : <ore:plateThulium>              ,
	<ore:ingotThulium>              : <ore:plateThulium>              ,
	<ore:ingotTin>                  : <ore:plateTin>                  ,
	<ore:ingotTinAlloy>             : <ore:plateTinAlloy>             ,
	<ore:ingotTitanium>             : <ore:plateTitanium>             ,
	<ore:ingotTungsten>             : <ore:plateTungsten>             ,
	<ore:ingotTungstenCarbide>      : <ore:plateTungstenCarbide>      ,
	<ore:ingotTungstenSteel>        : <ore:plateTungstenSteel>        ,
	<ore:ingotUranium>              : <ore:plateUranium>              ,
	<ore:ingotVanadium>             : <ore:plateVanadium>             ,
	<ore:ingotVibrantAlloy>         : <ore:plateVibrantAlloy>         ,
	<ore:ingotWroughtIron>          : <ore:plateWroughtIron>          ,
	<ore:ingotYttrium>              : <ore:plateYttrium>              ,
	<ore:ingotYttriumBariumCuprate> : <ore:plateYttriumBariumCuprate> ,
	<ore:ingotZinc>                 : <ore:plateZinc>                 
};
