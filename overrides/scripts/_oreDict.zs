...
mods.jei.JEI.removeAndHide(<armorplus:map>);
mods.jei.JEI.removeAndHide(<armorplus:map_of_the_end>);
mods.jei.JEI.removeAndHide(<armorplus:map_of_the_nether>);
mods.jei.JEI.removeAndHide(<armorplus:dungeon_placer_1>);
mods.jei.JEI.removeAndHide(<armorplus:dungeon_placer_2>);
mods.jei.JEI.removeAndHide(<armorplus:dungeon_placer_3>);
...
mods.jei.JEI.removeAndHide(<armorplus:map_device>);
